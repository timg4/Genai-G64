...
def parse_args() -> argparse.Namespace:
    ...
    default_results = repo_root / "experiments" / "evalution" / "runs_eval" / "eval_results.json"
    legacy_results = repo_root / "evalution" / "runs_eval" / "eval_results.json"
    results_default_value = str(default_results if default_results.exists() else legacy_results)

    parser = argparse.ArgumentParser(description="Compute metrics from eval_results.json")
    parser.add_argument(
        "--results",
        default=results_default_value,
